...
def finishedDialog(title, message):
    ...
    label.pack(side="top", fill="x", pady=80)  # More space around text

    # Create Exit Button
    exit_button = Button(dialog, text="เสร็จสิ้น", font=("Sarabun", 36), command=dialog.destroy, bg="red", fg="white",
                         padx=40, pady=20)
    exit_button.pack(pady=50)  # Add space below the message
    ...
    ok_button = ttk.Button(dialog, text="จบแบบสอบถาม", command=quit_application, style="Custom.TButton")
...
class MindfulAttentionAwarenessScale(Frame):
    def __init__(self, master, controller):
        ...
        self.questions = [
            ...
            "ฉันมักไม่ได้สังเกตถึงความรู้สึกตึงเครียดหรือความไม่สบายทางร่างกาย จนกว่า \nมันจะดึงความใส่ใจของฉัน",
            ...
            "ฉันเพ่งความสนใจไปยังเป้าหมายที่ต้องการโดยขาดการเชื่อมต่อระหว่างสิ่งที่ฉัน\nกำลังทำอยู่ในปัจจุบันกับจุดหมายนั้น",
...
class FFMQ_SF(Frame):
    ...
    def __init__(self, master, controller):
        ...
        original_bg = "#F0F0F0"  # Adjusted to match your provided image
        ...
        # Create a Text widget with matching background
        ...
        # Insert normal text
        text_widget.insert("insert", "โปรดอ่านข้อความ แล้วเลือกตัวเลขที่ตรงกับความเป็นจริงของท่านที่สุดใน ")

        # Insert highlighted text
        text_widget.insert("insert", "ช่วง 2 สัปดาห์ที่ผ่านมา", "highlight")

        # Configure the style for highlighted text
        ...
        self.questions = [
                        ...
                        "ฉันสามารถอธิบายความคิด ความเชื่อ และความคาดหวังของฉันออกมาเป็น\nคำพูดให้คนอื่นเข้าใจได้ง่าย",
                        ...
                        "ฉันใส่ใจในสัมผัสต่างๆ เช่น เมื่อลมต้องผมของฉัน หรือแสงอาทิตย์ที่ส่องบน\nใบหน้าของฉัน",
                        ...
                        "เมื่อฉันรับรู้ถึงความรู้สึกบางอย่างที่เกิดขึ้นกับร่างกายของฉัน ฉันไม่สามารถหาคำพูด\nที่เหมาะสมเพื่ออธิบายอาการนั้นได้",
                        ...
                        "ฉันสังเกตเห็นองค์ประกอบของภาพในงานศิลปะหรือธรรมชาติ เช่น สี รูปร่าง \nรายละเอียดหรือแนวของแสงและเงา",
...
class NonAttachmentToSelf(Frame):
    ...
    def __init__(self, master, controller):
        ...
        self.questions = [
                ...
                "ฉันสามารถสังเกตความคิดทางบวกและทางลบที่ฉันมีเกี่ยวกับตัวเองได้ โดยไม่เข้าไปยุ่งเกี่ยวกับ\nความคิดเหล่านั้น"
            ]
